...
TARGET_PREBUILT_KERNEL := device/samsung/noblelteskt/Image
TARGET_PREBUILT_DTB := device/samsung/noblelteskt/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/noblelteskt/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/noblelteskt/init/init_noblelteskt.cpp
